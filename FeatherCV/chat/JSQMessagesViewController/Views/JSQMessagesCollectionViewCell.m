...
#define ChatTextColor RGBCOLOR(200, 200, 200)
#define ChatShadowColor [UIColor blackColor]
...
- (void)awakeFromNib
{
    ...
    self.cellTopLabel.textColor = ChatTextColor;
    //[self.cellTopLabel enableShadow:ChatShadowColor];
    
    self.messageBubbleTopLabel.font = [UIFont boldSystemFontOfSize:12.0f];
    self.messageBubbleTopLabel.textColor = [UIColor lightGrayColor];
    self.messageBubbleTopLabel.textColor = ChatTextColor;
    //[self.messageBubbleTopLabel enableShadow:ChatShadowColor];
