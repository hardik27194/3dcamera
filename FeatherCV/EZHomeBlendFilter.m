...
- (id)init;
{
    ...
    [_skinBrighter setRgbCompositeControlPoints:@[pointValue(0.0, 0.0),pointValue(0.125, 0.135), pointValue(0.25, 0.29), pointValue(0.5, 0.51), pointValue(0.75, 0.75), pointValue(1.0, 1.0)]];
