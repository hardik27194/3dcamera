...
{
    [self startGlowingWithColor:color fromIntensity:fromIntensity toIntensity:toIntensity repeat:repeat duration:1.0];
}
...
{
    [self startGlowingWithColor:[UIColor whiteColor] fromIntensity:0.1 toIntensity:0.6 repeat:YES duration:duration];
}
