...
NSString *const kHomeImageCropFragmentShaderString =  SHADER_STRING
(
...
@interface EZBlackAndCropFilter ()
...
@implementation EZBlackAndCropFilter
...
{
    if (!(self = [super initWithFragmentShaderFromString:kHomeImageCropFragmentShaderString]))
    {
        return nil;
    }
